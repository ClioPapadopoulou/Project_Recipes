...
<div class="container mt-5 mb-5">
    ...
    <div class="row">
        <div class="col-md-8">
            <p>
                Welcome to <strong>MyWebsite</strong>, your go-to platform for [describe purpose of site here, e.g., "sharing knowledge, connecting professionals, and learning new skills"].
            </p>
            <p>
